...
import com.authentication.security.auth.RestAuthenticationEntryPoint;
import com.authentication.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/auth/**","/registerRequest","/user/username").permitAll().antMatchers("/h2-console/**").permitAll()
                .antMatchers("/codebook/getCodeBookInfo").permitAll().antMatchers(HttpMethod.GET, "/advertisement").permitAll().antMatchers(HttpMethod.GET, "/user/**").permitAll().antMatchers(HttpMethod.PUT, "/user/**").permitAll()
