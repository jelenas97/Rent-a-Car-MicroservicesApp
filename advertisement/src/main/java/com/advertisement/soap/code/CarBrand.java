 ...
 *         &lt;element name="carModels" type="{http://localhost:8084/advertisement}carModel" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "carBrand", namespace = "http://localhost:8084/advertisement", propOrder = {
    "car",
    "carModels",
    "id",
    "name",
