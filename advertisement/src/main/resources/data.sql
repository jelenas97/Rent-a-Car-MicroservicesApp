...
insert into car(available_tracking, image, kid_seats, mileage, name, rate, car_brand_id, car_class_id,
...
insert into car(available_tracking, image, kid_seats, mileage, name, rate, car_brand_id, car_class_id,
                transmission_type_id, car_model_id)
values (1, 'https://liquipedia.net/commons/images/7/74/RL_%2789_Batmobile.jpg', 0, 10000, 'Batmobile', 10.0, 2, 2, 2,
        2);
insert into advertisement(cdw, discount, place, kilometres_limit, car_id, owner_id, price_list_id, start_date, end_date)
...
insert into car(available_tracking, image, kid_seats, mileage, name, rate, car_brand_id, car_class_id,
                transmission_type_id, car_model_id)
values (0, 'https://nfsmods.xyz/userdata/Marco3156/2019-Bugatti-Divo-V1-1080.jpg', 3, 54000, 'BB-Gier', 9.0, 3, 3, 3,
        3);
insert into advertisement(cdw, discount, place, kilometres_limit, car_id, owner_id, price_list_id, start_date, end_date)
